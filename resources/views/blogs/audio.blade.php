                ...
                @forelse($blogs as $blog)
                    <article class="masonry__brick entry format-audio" data-aos="fade-up">
                        ...
                        <div class="entry__thumb">
                            <a href="{!! '/blogs/bloge/showaudio/'.$blog->id !!}" class="entry__thumb-link">
                                <img src="{{ asset('/storage/'. $blog->pics) }}"
                                     srcset="{{ asset('/storage/'. $blog->pics) }} 1x, {{ asset('/storage/'. $blog->pics) }} 1x" alt="">
                            </a>
                            <div class="audio-wrap">
                                <audio id="player" src="{!! $blog->video !!}" width="100%" height="42" controls="controls"></audio>
                            </div>
                        </div>
                        ...
                        <div class="entry__text">
                            <div class="entry__header">
                                ...
                                <h1 class="entry__title"><a href="{!! '/blogs/blog/showaudio/'.$blog->id !!}">{!! $blog->title !!}</a></h1>
